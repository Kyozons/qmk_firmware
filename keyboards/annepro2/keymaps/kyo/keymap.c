...
*/
 ...
 [_BASE_LAYER] = KEYMAP( /* Base */
    ...
    LT(_FN3_LAYER,KC_TAB), KC_SLSH, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, KC_BSPC, KC_LBRC, KC_BSLS,
    LT(_FN2_LAYER,KC_ESC), KC_A, KC_O, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_N, KC_S, KC_MINS, KC_ENT,
    KC_LSFT, KC_NUBS, KC_Q, KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, KC_V, KC_Z, RSFT_T(KC_UP),
    KC_LCTL, KC_LGUI, KC_LALT, TD(TD_SPC_ENT), KC_RALT, LT(_FN4_LAYER,KC_LEFT), LT(_FN3_LAYER,KC_DOWN), RCTL_T(KC_RGHT)
),
...
[_FN1_LAYER] = KEYMAP( /* Base */
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, LT(_FN4_LAYER,KC_LEFT), LT(_FN3_LAYER,KC_DOWN), RCTL_T(KC_RGHT)
),
